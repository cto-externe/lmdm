...
func (d *Deps) handleCreateToken(w http.ResponseWriter, _ *http.Request)   { writeError(w, 501, "not implemented") }
func (d *Deps) handleListTokens(w http.ResponseWriter, _ *http.Request)    { writeError(w, 501, "not implemented") }
